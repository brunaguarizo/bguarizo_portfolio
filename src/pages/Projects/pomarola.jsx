    ...
    return (
        <div className={styles.container}>
            ...
            <h2 className={styles.title_details}>
                Transforming traditional recipes into scroll-stopping digital
                experiences
            </h2>
            ...
            <div
                ...
                <div
                    ...
                    <p className={styles.section_description}>2019</p>
            ...
            <video
                ref={firstImageRef}
                src='/pomarola/pomarola-image1.mp4'
                autoPlay
                loop
                muted
                playsInline
